...
export class MuiTextareaHarness extends ComponentHarness {
  static hostSelector = 'textarea[muiTextarea]';
  ...
  async getResize(): Promise<string | null> {
    const host = await this.host();
    return host.getAttribute('data-resize');
  }
