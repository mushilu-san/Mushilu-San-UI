---
name: hunt-echo
description: Hunts accessibility gaps across all components — missing roles, keyboard handling, focus rings, touch targets, motion guards, and Accessibility stories (CLAUDE.md §Accessibility requirements, §Code standards — E2E).
