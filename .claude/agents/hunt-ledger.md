---
name: hunt-ledger
description: Hunts dependency hygiene — npm audit advisories, lockfile drift, duplicate packages, and peer-dep version mismatches (CLAUDE.md §Dependency & lockfile rules).
