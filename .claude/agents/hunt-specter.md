---
name: hunt-specter
description: Hunts null-safety violations, bad event-handling, and lifecycle asymmetry in component source (CLAUDE.md §Code standards — Null safety, Event handling, Lifecycle & cleanup, Logic guards).
