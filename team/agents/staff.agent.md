...
codename: Staff
slash: mui-review
role: Staff-engineer review of a component diff for Angular-zoneless correctness, security, and simplicity — signal APIs, OnPush, no innerHTML, surgical changes.
use_when: a component or change is built and the user wants a code review, asks to "review the diff", "staff review", "check the implementation", or catch correctness/over-engineering before tests and ship. Sixth stage of the Studio pipeline.
---
