...
name: hunt-lattice
kind: hunter
role: Hunts duplicated logic that should use shared utilities — overlay positioning, roving tabindex, CVA boilerplate, and pointer-drag lifecycle (CLAUDE.md §Code standards — Shared utilities, DD-1 through DD-4).
---
