...
name: hunt-vapor
kind: hunter
role: Hunts E2E coverage gaps — overlays missing focus/Escape/return-focus tests, touch-gesture components missing Playwright pointer simulation, and interactive components lacking a Default story for E2E (CLAUDE.md §Code standards — E2E).
---
