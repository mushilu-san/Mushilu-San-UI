...
name: hunt-prism
kind: hunter
role: Hunts type-safety gaps — as-any casts, non-null assertions, legacy @Input/@Output decorators, and missing booleanAttribute/numberAttribute transforms (CLAUDE.md §Code standards — Null safety, Signals & reactivity).
---
